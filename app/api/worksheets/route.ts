...
export async function POST(request: Request) {
  return apiRoute(async () => {
    ...
    if (data.templateId) {
      ...
      content = { cells: built.cells, body: built.body, widths: built.widths, formats: built.formats, bold: built.bold, analysis: built.analysis, recipes: [], frozenColumns: 0, styles: {}, merges: [], notes: {}, hiddenRows: [], hiddenColumns: [] };
