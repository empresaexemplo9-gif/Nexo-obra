      ...
      <div className="relative mx-auto -mt-10 max-w-[1500px] px-4 pb-14 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="resumo" className="mt-8">
          ...
          <TabsContent value="registros" className="mt-6 space-y-6">
            ...
            <Card className="workspace-card border-border"><CardHeader><CardTitle className="flex items-center gap-2"><ClipboardCheck className="size-5 text-hoikos-600" />Outros registros operacionais</CardTitle><p className="text-sm leading-6 text-hoikos-500">As próximas conexões serão ativadas sem inserir dados demonstrativos.</p></CardHeader><CardContent className="grid gap-3 sm:grid-cols-3"><ModuleCard title="Compras" description="Cotações, pedidos e fornecedores." status="Próxima conexão" icon={Boxes} /><ModuleCard title="Medições" description="Evolução física e aprovações." status="Próxima conexão" icon={ClipboardCheck} /><ModuleCard title="Arquivos" description="Projetos, contratos e comprovantes." status="Próxima conexão" icon={FileStack} allowed={can(session, "files")} /></CardContent></Card>
          </TabsContent>
