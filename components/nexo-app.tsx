    ...
    <main className="relative grid min-h-svh place-items-center overflow-hidden bg-[#06111f] p-5">
      ...
      <Card className="relative w-full max-w-lg border-white/10 bg-slate-950/80 text-white shadow-2xl backdrop-blur-xl">
        <CardContent className="p-7 sm:p-9">
          ...
          <p className="mt-6 flex items-center justify-center gap-2 text-xs text-slate-500"><ShieldCheck className="size-4" />Acesso protegido e dados separados por empresa.</p><p className="mt-3 text-center text-xs"><a href="/termos" className="text-cyan-300 hover:text-cyan-200">Termos de Uso e Privacidade</a></p>
        </CardContent>
      </Card>
    </main>
  );
